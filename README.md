...
[![GitHub Release](https://img.shields.io/github/v/release/Felix2CN/Anti-tools?label=GitHub%20Release&color=blue)](https://github.com/Felix2CN/Anti-tools/releases)
...
- **📦 手动安装**：从 [Releases](https://github.com/Felix2CN/Anti-tools/releases) 下载最新 `.vsix` 文件，  
